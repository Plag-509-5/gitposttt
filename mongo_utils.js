...
async function initMongo() {
  ...
  client = new MongoClient(process.env.MONGO_URI || 'mongodb+srv://daveowenwendelpierre_db_user:Ab8pCcszJjY2eroe@kaidomd.sq5pttt.mongodb.net/', {
    useNewUrlParser: true,
    useUnifiedTopology: true
  });
  await client.connect();
  db = client.db(process.env.MONGO_DB || 'MUGIWARA_NO_PLAG');
